...
3. 각 파일 세부 설명
    ...
    [main.exe]
        Windows 11 환경에서 실행 가능한 main.c의 컴파일된 코드이다.
    ...
    [main_simulate.exe]
        Windows 11 환경에서 실행 가능한 main_simulate.c의 컴파일된 코드이다.
...
4. 코드 실행 방법
    # Ubuntu 22.04 LTS
        ...
        [main_simulate.c]
            $ gcc main_simulate.c -o simulate_map_rvc
            $ ./simulate_map_rvc
    
    # Windows 11
        [main.c]
            $ gcc main.c -o rvc.exe
            $ ./rvc.exe

        [main_simulate.c]
            $ gcc main_simulate.c -o simulate_map_rvc.exe
            $ ./simulate_map_rvc.exe
